...
const List = ({ type }) => {
  ...
  useEffect(() => {
    getOrdersFromFirebase().then((orders) => console.log("eqfrshfyj", orders));
  }, []);
            ...
            <>
              <TableRow>
                ...
                <TableCell className="tableCell1" colSpan={2}>
                  {orders.find((order) => order.id === orderId).User.name}
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell className="tableCell2" colSpan={2}>
                ...
                <TableCell className="tableCell1" colSpan={2}>
                  {orders.find((order) => order.id === orderId).User.address}
                </TableCell>
              </TableRow>
            </>
          )}
